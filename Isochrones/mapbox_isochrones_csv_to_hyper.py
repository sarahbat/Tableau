...
* pt_file_loc - where is your csv?  Note that you need fields named "latitude" and "longitude" specifically.  I did not aim for flexibility in this quick script :) 
...
path_to_hyper = r"your_output_hyper_file.hyper.hyper"
